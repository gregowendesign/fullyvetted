...
<body <?php body_class(); ?>>
    <div class="stretch">
        <img src="http://localhost:8888/Fullyvetted.co.uk/wordpress//wp-content/themes/fullyvetted.co.uk/images/bg_Rabbit.jpg" name="Boy holding a rabbit" alt="Picture of a boy holding a rabbit">
    </div><!--stretch-->
    <div id="wrapper">
      <div id="container">
        <header>        
